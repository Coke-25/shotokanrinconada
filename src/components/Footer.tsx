        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/club-shotokan" className="text-gray-400 hover:text-red-600 transition-colors">
                  CLUB SHOTOKAN
                </Link>
              </li>
              <li className="pl-4">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href="#" className="w-10 h-10 bg-red-700 rounded-full flex items-center justify-center hover:bg-red-800 transition-colors text-white">
